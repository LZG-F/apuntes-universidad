...
\begin{corollary}
	$C_{\R}([a,b])$ es denso en $L_{\R}^{1}([a,b])$. En particular, $\overline{\mcal{R}([a,b])} = L_{\R}^{1}([a,b])$ con la métrica $d_{L^{1}}$, donde 
	\[ \mcal{R}([a,b]) \coloneq \{[f] \ \big| \ f : [a,b] \to \R \text{ integrable Riemann}\}. \]
\end{corollary}

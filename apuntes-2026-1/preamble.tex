...
\declaretheorem[sibling=definition, style=thmredbox, name=Propiedad]{property}
\declaretheorem[sibling=definition, style=thmredbox, name=Afirmación]{af}
%AGREGADO
...
\declaretheorem[style=thmblueline, numbered=no, name=Comentarios]{comentarios}
\declaretheorem[style=thmblueline, numbered=no, name=Nota]{note}
\declaretheorem[style=thmblueline, numbered=no, name=Aclaración]{aclaracion}

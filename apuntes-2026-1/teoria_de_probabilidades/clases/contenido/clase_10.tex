...
\begin{definition}
	...
	\begin{itemize}
		\item Si la convergencia en $(*)$ es en probabilidad, decimos que la ley es \textit{débil}.

		\item Si la convergencia en $(*)$ es casi segura, decimos que la ley es \textit{fuerte}.
	\end{itemize}
\end{definition}
...
\begin{theorem}
	...
	\[ \begin{cases}
		...
		\Var(X_{n}) \leq c < \infty \quad \forall n \in \N,
	\end{cases} \]
...
\begin{proof}[Proof Other Information]
	...
	\begin{align*}
		...
		&= \frac{1}{n} \Big( \sum_{i=1}^{n} \mbb{E}(X_{i}) \Big) \\
		&= \frac{1}{n} n \mu = \mu
	.\end{align*}
	y
	\begin{align*}
...
\begin{remark}
	\begin{enumerate}
		\item Si $(X_{n})_{n \in \N}$ son NC, entonces $\Var(X_{1} + \cdots + X_{n}) = \Var(X_{1}) + \cdots + \Var(X_{n})$.

		\item Que convergencia en $L^{2}$ implique convergencia en $\mbb{P}$ se deduce de la siguiente desigualdad:
...
\begin{note}
	Las hipótesis sobre los momentos de $(X_{n})_{n \in \N}$ se puede relajar mediante \textit{truncamientos} de las variables; i.e, cambiar $X_{n}$ por $\widetilde{X}_{n} = X_{n} \mathds{1}_{|X_{n}| \leq b_{n}}$.
\end{note}
...
\begin{note}
	No obstante, si $\mbb{E}(|X_{n}|) = \infty$, pero $X_{n}$ es $\mbb{P}$-débil integrable, sigue valiendo la LFGN en el sentido esperable.
\end{note}

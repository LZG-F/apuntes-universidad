...
\begin{lemma}
	Sea $\beta^{I} \coloneq \bigtimes_{i \in I} \beta$ (esto no es producto cartesiano, sino producto de $\sigma$-álgebras) la menor $\sigma$-álgebra en $S^{I}$ que contiene alos conjuntos de la forma
	\[ C(t, B) \coloneq \{(x_{i})_{i \in I} \in S^{I} \ : \ x_{t} \in B\} \quad (= \pi_{t}^{-1}(B)) \]
	con $t \in I,\ B \in \beta$. \par
	Entonces, $\beta^{I}$ es la menor $\sigma$-álgebra en $S^{I}$ que hace que $\pi_{t}$ sea $\beta$-medible $\forall t \in I$. A su vez, $\sigma(X_{t} \ : \ t \in I)$ es la menor $\sigma$-álgebra tal que $X \colon \Omega \to S^{I}$ resulta $\beta^{I}$-medible
\end{lemma}
...
\begin{proof}[Proof Other Information][Lema]
	\begin{enumerate}
		...
		\item Sea $\mcal{G} \subseteq \mcal{F}$ es una $\sigma$-álgebra.
		\begin{align*}
